"""
HelixDesk OpenEnv — Gradio HuggingFace Spaces Dashboard.

Single-screen interactive demo: run episodes with rule/random agents,
view reward and queue depth charts, and episode summary stats.
"""
